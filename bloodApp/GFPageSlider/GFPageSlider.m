...
- (void)initMenuScrollView {
    ...
    _menuScrollView.backgroundColor = [UIColor colorWithRed:0.82 green:0.16 blue:0.22 alpha:1.0];
...
- (void)moveIndicatorWithButton:(UIButton *)menuButton {
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        if([menuButton isKindOfClass:[UIButton class]]) {
            [_previousButton setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
            [menuButton setTitleColor:_indicatorLineColor forState:UIControlStateNormal];
